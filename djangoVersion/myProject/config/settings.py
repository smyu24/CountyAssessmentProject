...
SECRET_KEY = env(
    "SECRET_KEY", default="django-insecure-pj)2u^p2$o8281740^b-517mox%oxzupqrhre$lir8uw+dizimqvqkj)"
)
...
DATABASES = {
    "default": env.dj_db_url("DATABASE_URL", default="postgres:///myProject"),
}
